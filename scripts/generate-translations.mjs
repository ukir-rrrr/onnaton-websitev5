...
const phraseT = {
  ...
  "（秘伝の熟成合わせ出汁）": { yue: "（秘傳熟成合煮湯底）", zhTw: "（秘傳熟成合煮湯底）" },
  "沖縄県産黒毛和牛": { yue: "沖繩縣產黑毛和牛", zhTw: "沖繩縣產黑毛和牛" },
  "沖縄県産": { yue: "沖繩產", zhTw: "沖繩產" },
  "黒毛和牛": { yue: "黑毛和牛", zhTw: "黑毛和牛" },
  "もとぶ牛": { yue: "本部牛", zhTw: "本部牛" },
  "もとぶ牛（Ａ５ランク）": { yue: "本部牛（A5）", zhTw: "本部牛（A5）" },
  "（Ａ５ランク）": { yue: "（A5）", zhTw: "（A5）" },
  "山城牛": { yue: "山城牛", zhTw: "山城牛" },
  "山城牛（Ａ５ランク）": { yue: "山城牛（A5）", zhTw: "山城牛（A5）" },
  "特選石垣牛": { yue: "特選石垣牛", zhTw: "特選石垣牛" },
  ...
  "目の前で焼き上げる": { yue: "即場燒製嘅", zhTw: "當面烤製的" },
  "焼きチーズリゾット": { yue: "芝士燴飯", zhTw: "芝士燴飯" },
  "アイスクリーム": { yue: "雲呢拿雪糕", zhTw: "香草冰淇淋" },
  "沖縄県産黒蜜きな粉": { yue: "沖繩黑糖黃豆粉", zhTw: "沖繩黑糖黃豆粉" },
  "沖縄県産黒蜜きな粉アイスクリーム": {
    yue: "沖繩黑糖黃豆粉雲呢拿雪糕",
    zhTw: "沖繩黑糖黃豆粉香草冰淇淋",
  },
  ...
  "シャトーブリアン": { yue: "菲力", zhTw: "菲力" },
  "ステーキ": { yue: "牛扒", zhTw: "牛排" },
  "シャトーブリアンステーキ": { yue: "菲力牛扒", zhTw: "菲力牛排" },
  ...
  "エグゼクティブ 華 -HANA-": { yue: "Executive 華 -HANA-", zhTw: "Executive 華 -HANA-" },
  "エグゼクティブ 極 -KIWAMI-": { yue: "Executive 極 -KIWAMI-", zhTw: "Executive 極 -KIWAMI-" },
  "エグゼクティブ 煌 -KOU-": { yue: "Executive 煌 -KOU-", zhTw: "Executive 煌 -KOU-" },
